...
class SiameseSamplerDataset:
    ...
    def __getitem__(self, idx):
        ...
        if self.normalize:
            data_1 = normalize_non_black_pixels(data_1, self.mean, self.std)
            data_2 = normalize_non_black_pixels(data_2, self.mean, self.std)
...
class SiameseValidationDataset(BaseLabeledCocoDataset):
    ...
    def __getitem__(self, idx: int):
        ...
        if self.normalize:
            data = normalize_non_black_pixels(data, self.mean, self.std)
