...
from engine.embedder.siamese.siamese_dataset_old import SiameseSamplerDataset, SiameseSamplerInternalDataset, \
...
if __name__ == '__main__':
    ...
    siamese_sampler = SiameseSamplerDataset(
    ...
    model = SiameseNetwork(resnet_model=resnet_model, final_embedding_size=final_embedding_size).to(device)
