...
if __name__ == '__main__':
    ...
    tilerizer = Tilerizer(
        data_path=Path("/home/hugobaudchon/PycharmProjects/xprize-rainforest/data/reforestree/tiles/Carlos Vera Arteaga RGB.tif"),
        annot_path=Path("/data/reforestree/annotations/Carlos Vera Arteaga RGB_annotations.csv")
    )
    tilerizer.create_tiles(tile_size=1024)
