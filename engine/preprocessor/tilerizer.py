...
if __name__ == '__main__':
    ...
    tilerizer = Tilerizer(
        # data_path=Path("/home/hugobaudchon/PycharmProjects/xprize-rainforest/data/reforestree/wwf_ecuador/RGB Orthomosaics/Nestor Macias RGB.tif"),
        # annot_path=Path("/home/hugobaudchon/PycharmProjects/xprize-rainforest/data/reforestree/mapping/final_dataset.csv"),
